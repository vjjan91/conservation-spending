...
ggsave(fig_threats_funding, filename = "figs\\fig_threats_mismatch.png", width=17, height=7,
       device = png(), units="in", dpi = 300)
```

```{r, fig.cap='Fig. 1: Mismatch between conservation funding and drivers of biodiversity loss'}
# show exported image
knitr::include_graphics("figs/fig_threats_mismatch.png")
```

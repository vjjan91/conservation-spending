...
ggsave(fig.2a.plot, filename = "figs\\Fig.2A.png", width=12, height=7,device = png(), units="in",dpi = 300)
...
ggsave(fig.2b.plot, filename = "figs\\Fig.2B.png", width=12, height=7,device = png(), units="in", dpi = 300)
```

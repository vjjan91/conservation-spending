...
ggsave(plot.pie.Nthreats_climate, filename = "figs\\fig_pie_climate.png", width=12, height=7,dpi = 300)
```

```{r, fig.cap='Proportion of climate change funding that was shared between multiple threat categories', fig.align='center'}
# show exported image
...
ggsave(plot.pie.Nthreats_energytransport, filename = "figs\\fig_pie_energytransport.png", width=12, height=7,dpi = 300)
```

```{r, fig.cap='Proportion of energy/transportation funding that was shared between multiple threat categories', fig.align='center'}
# show exported image
...
ggsave(plot.pie.Nthreats_habitat, filename = "figs\\fig_pie_habitatloss.png", width=12, height=7,dpi = 300)
```

```{r, fig.cap='Proportion of habitat loss funding that was shared between multiple threat categories', fig.align='center'}
# show exported image
...
ggsave(plot.pie.Nthreats_inv_spec, filename = "figs\\fig_pie_invasiveSpecies.png", width=12, height=7,dpi = 300)
```

```{r, fig.cap='Proportion of invasive species funding that was shared between multiple threat categories', fig.align='center'}
# show exported image
...
ggsave(plot.pie.Nthreats_overexp, filename = "figs\\fig_pie_overexploitation.png", width=12, height=7,dpi = 300)
```

```{r, fig.cap='Proportion of overexploitation funding that was shared between multiple threat categories', fig.align='center'}
# show exported image
...
ggsave(plot.pie.Nthreats_pollution, filename = "figs\\fig_pie_pollution.png", width=12, height=7,dpi = 300)
```

```{r, fig.cap='Proportion of pollution funding that was shared between multiple threat categories', fig.align='center'}
# show exported image

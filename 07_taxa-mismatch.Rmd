...
```{r, fig.cap='Figure 3 - Mismatch between the proportion of funding allocated toward taxonomic groups and the proportion of threatened species within these taxonomic groups'}
# show exported image

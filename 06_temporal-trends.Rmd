...
```{r,fig.cap='Figure 2A - Temporal variation (2003-2016) in proportion of funding across unique threat categories per year'}
# show exported image
...
```{r, fig.cap='Figure 2B - Temporal variation (2003-2016) in overall allocation of money across unique threat categories per year'}
# show exported image

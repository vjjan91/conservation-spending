...
# Preparation of a final dataframe of classified grants

Here we prepare a final datafame for analysis of threats, taxonomic groups and proportion of funding
```{python eval=FALSE}
import pandas as pd
import numpy as np
import math
